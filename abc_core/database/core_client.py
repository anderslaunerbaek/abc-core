...
class DBCore:
    ...
    def close_connection(self) -> None:
        try:
            ...
            logging.error(
                f"Not able to close db connection. Got following msg: {msg}..."
            )
    ...
    def select(
        self, query: str, data: tuple[Any, ...] = None
        ...
        with self as cursor:
            try:
                ...
                logging.error(
                    f"Error for select query: {query} with following msg: {msg}..."
                )
    ...
    def insert(self, query: str, data: tuple[Any, ...]) -> bool:
        ...
        with self as cursor:
            try:
                ...
                logging.error(
                    f"Error for insert query: {query} with following msg: {msg}..."
                )
    ...
    def update(self, query: str, data: tuple[Any, ...]) -> bool:
        ...
        with self as cursor:
            try:
                ...
                logging.error(
                    f"Error for update query: {query} with following msg: {msg}..."
                )
                self.connection.rollback()
                return False
